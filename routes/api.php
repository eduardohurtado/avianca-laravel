...
Route::resource('fabricantes', 'App\Http\Controllers\FabricanteController', ['except' => ['edit', 'create']]);   // Todos los métodos menos Edit que mostraría un formulario de edición.
...
Route::resource('aviones', 'App\Http\Controllers\AvionController', ['only' => ['index', 'show']]);
...
Route::resource('fabricantes.aviones', 'App\Http\Controllers\FabricanteAvionController', ['except' => ['show', 'edit', 'create']]);
